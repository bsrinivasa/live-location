...
var map = new mapboxgl.Map({
  ...
  style: 'mapbox://styles/bsrinivasa/cjans8p8e29vy2rqwseeekc72', //stylesheet location
...
map.on('load', function() {
  ...
  function getCurrentLocation() {
    ...
    $.get('https://api.mapbox.com/datasets/v1/bsrinivasa/cjhrgolsv014i2vo1rvqjh4rp/features/latest?access_token='+mapboxgl.accessToken)
      .done(function(d) {
